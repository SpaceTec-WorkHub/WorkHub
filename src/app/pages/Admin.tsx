...
export default function Admin() {
  ...
  // user management state (from HEAD)
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <ul className="space-y-4 mb-6">
              {usuarios.map((user) => (
                <li key={user.user_id} className="flex items-center justify-between">
                  ...
                  <button className="px-3 py-1 bg-red-600 text-white text-xs rounded" type="button">
                    Eliminar
                  </button>
                </li>
              ))}
            ...
            <div className="flex gap-2">
              ...
              <button
                className="ml-auto px-4 py-2 bg-red-600 text-white text-sm font-bold rounded hover:bg-red-700 transition-colors"
                onClick={() => setventana_usuarios(false)}
                type="button"
              >
                Cerrar
              </button>
          ...
          <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-lg w-full max-w-md">
            ...
            <form onSubmit={agregarUsuario} className="space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded focus:outline-none focus:ring focus:ring-blue-200"
              ...
              <div>
                ...
                <input
                  type="email"
                  className="w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded focus:outline-none focus:ring focus:ring-blue-200"
                  placeholder="Ej: ana@martinez.com"
                  value={correo}
            ...
            <button
              className="mt-4 px-4 py-2 bg-red-600 text-white text-sm font-bold rounded hover:bg-red-700 transition-colors"
              onClick={() => setVentanaAgregar(false)}
              type="button"
            >
              Cancelar
            </button>
